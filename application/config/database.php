...
if (defined('CI_VERSION') && substr(CI_VERSION, 0, 1) != '2') {
    ...
    $db['default'] = array(
        ...
        'username'     => 'b0d11e0fdaf929',
        'password'     => '0fa91778',
        'database'     => 'heroku_1a61d1a5da29d4b',
        'dbdriver'     => 'mysqli',
        'dbprefix'     => 'bf_',
        'pconnect'     => false, // not supported with the database session driver
        'db_debug'     => true,
    ...
    $db['default']['username'] = 'b0d11e0fdaf929';
    $db['default']['password'] = '0fa91778';
    $db['default']['database'] = 'heroku_1a61d1a5da29d4b';
    $db['default']['port']     = '';
    $db['default']['dbdriver'] = 'bfmysqli';
    $db['default']['dbprefix'] = 'bf_';
